        ...
        <el-row>
          <el-col :span="4">
            <el-form-item label="商品名称" class="postInfo-container-item">
              <el-input v-model="listQuery.goods_name" placeholder="请输入预约人账号" style="width: 200px;" class="filter-item"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getGoods() {
        let params = objectMerge(goodsFilter[this.$route.name], this.listQuery)
